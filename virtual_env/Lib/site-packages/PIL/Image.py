...
from . from PIL import ImageMode, TiffTags, UnidentifiedImageError, __version__, _plugins
...
try:
    ...
    # from PIL import Image and use the Image.core variable instead.
...
class Image:
    ...
    * :py:func:`~PIL.Image.frombytes`
    ...
    def _new(self, im):
        ...
        if im.mode in ("P", "PA"):
            if self.palette:
                ...
                from . from PIL import ImagePalette
    ...
    def filter(self, filter):
        ...
        from . from PIL import ImageFilter
    ...
    def paste(self, im, box=None, mask=None):
        ...
        if isinstance(im, str):
            from . from PIL import ImageColor
...
def _show(image, **options):
    from . from PIL import ImageShow
    ...
    def get_ifd(self, tag):
        if tag not in self._ifds:
            if tag in [0x8769, 0x8825]:
                ...
                if tag == 0x927C:
                    # makernote
                    from .TiffImagePlugin from PIL import ImageFileDirectory_v2
